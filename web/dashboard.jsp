...
<body class="min-h-screen bg-slate-950 text-slate-100">
  <div class="max-w-5xl mx-auto p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <a class="rounded-xl border border-slate-800 bg-slate-900/60 p-5 hover:border-cyan-500" href="<%= request.getContextPath() %>/student/schedule">
        <h2 class="font-semibold mb-1">Student View</h2>
        <p class="text-sm text-slate-400">Live weekly routine</p>
      </a>
      <a class="rounded-xl border border-slate-800 bg-slate-900/60 p-5 hover:border-cyan-500" href="<%= request.getContextPath() %>/teacher/request">
        <h2 class="font-semibold mb-1">Teacher Panel</h2>
        <p class="text-sm text-slate-400">Submit schedule changes</p>
      </a>
      <a class="rounded-xl border border-slate-800 bg-slate-900/60 p-5 hover:border-cyan-500" href="<%= request.getContextPath() %>/admin/approval">
